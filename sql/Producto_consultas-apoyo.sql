...
select distinct * from categoria_producto order by id_producto;
...
select emparejar.id_producto,nombre as salsa,nivel_picor from emparejar cross join salsa order by id_producto;
